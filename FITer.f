     ...
     #2,-0.02521,0.01125,-0.004978,0.002072,-0.000318/
      !corrimiento,n puntos por decada, puntos que necesita el filtro
      !espaciamiento:
      s=-0.13069
      npd=6
      npf=20
...
77    close(30)
      ...
      !siendo n abscisas efecto la siguiente iteracion
      do k=1,n
      !calculo la ubicacion de puntos centrado en la abscisa
        h=0
        do j=1,npf
            h=h+1
      ...
      !calculo la convolucion entre el filtro y la transformada de resist
